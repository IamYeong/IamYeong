...
<img src="https://user-images.githubusercontent.com/59534301/184597853-55a30695-cc2c-4c03-809a-e7420c9ae098.png" width="80px" height="80px" title="px(픽셀) 크기 설정" alt="RubberDuck"></img>

제가 지인들 정보를 심히 기억을 못 해서 오래전부터 메모할 공간이 필요했습니다.    
하지만 구글킵, 메모앱, 명함앱 들은 제 의도대로 활용하기 어려웠고    
결국 전용앱을 만들고 이런 어려움을 겪는 사람들에게 마케팅해보기로 했습니다.     
Firebase 와 연동하여 카카오톡처럼 설정에서 동기화를 가능하게 했습니다.    
매번 트랜잭션마다 서버의 응답을 기다리는 것은 딱히 좋지 못 한 방법이라고 느꼈기 때문입니다.    
